...
void Lab7::Init()
{
    ...
    // Light & material properties
    {
        ...
        lightPosition2 = glm::vec3(1, 2, -1);
        lightColor2 = glm::vec3(0, 0, 1);
...
void Lab7::Update(float deltaTimeSeconds)
{
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(1.f, 0.f, 0.1f));
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.2f, 0.7f, 0.5f));
    }
    ...
    // Render ground
    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(.0f, .5f, .3f));
...
void Lab7::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, const glm::vec3& color)
{
    ...
    glUniform3f(light_color2, lightColor2.r, lightColor2.g, lightColor2.b);
...
void Lab7::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        if (window->KeyHold(GLFW_KEY_2)) lightPosition2 += forward * deltaTime * speed;
        if (window->KeyHold(GLFW_KEY_3)) lightPosition2 -= right * deltaTime * speed;
